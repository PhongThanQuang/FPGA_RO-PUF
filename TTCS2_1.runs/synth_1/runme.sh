...
HD_PWD='C:/Users/admin/Downloads/TTCS2_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Hybrid2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Hybrid2.tcl
