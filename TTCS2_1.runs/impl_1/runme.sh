...
HD_PWD='C:/Users/admin/Downloads/TTCS2_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Hybrid2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Hybrid2.tcl -notrace
